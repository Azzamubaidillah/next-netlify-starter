...
export default function PrivacyPolicy() {
  return (
    <div className="page">
      <Head>
        <title>Privacy Policy for Voice Qur'an</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>

      <div className="header">
        <div className="container">
          <p className="title">Privacy Policy for Voice Qur'an</p>
        </div>
      </div>
        ...
        <div className="container">
          <div className="tab-content translations-content-item en visible" id="en">
            ...
            <ul>
              ...
              <li><p><strong>Application</strong> refers to Voice Qur'an, the software program provided by the Company.</p></li>
              <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Voice Qur'an.</p></li>
              <li><p><strong>Country</strong> refers to: Indonesia</p></li>
            ...
            <ul>
              ...
              <li><p><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products, or contracted services, including security updates, when necessary or reasonable for their implementation.</p></li>
              ...
              <li><p><strong>To manage Your requests:</strong> To attend to and manage Your requests to Us.</p></li>
            ...
            <h2>Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, You can contact us: azzam.ubaidillah@gmail.com</p>
          </div>
        </div>
      </div>
